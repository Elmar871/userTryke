...
class PayFareAmountDialogCancel extends StatefulWidget {

  double? fareAmount;

  PayFareAmountDialogCancel({this.fareAmount});

  @override
  State<PayFareAmountDialogCancel> createState() => _PayFareAmountDialogCancelState();
}

class _PayFareAmountDialogCancelState extends State<PayFareAmountDialogCancel> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: ElevatedButton(
                ...
                onPressed: () async {
                  Fluttertoast.showToast(msg: "Rate the driver. Please wait.");
