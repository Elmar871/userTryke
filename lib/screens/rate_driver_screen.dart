...
class RateDriverScreen extends StatefulWidget {
  ...
  RateDriverScreen({this.assignedDriverId, this.userRideRequestDetails});
...
class _RateDriverScreenState extends State<RateDriverScreen> {
  ...
  void saveComment() {
    ...
    DatabaseReference commenttoDriver = FirebaseDatabase.instance.ref()
        .child("drivers")
        .child(widget.assignedDriverId!)
        .child("comments");

    commenttoDriver.push().set(controller.text);
  }
}
