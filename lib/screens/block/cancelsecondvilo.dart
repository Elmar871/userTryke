...
class CancelSecondViolation extends StatelessWidget {
  _submit() {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content: Text("This is your 2nd violation for cancelling a ride. "
          "Please report to admin for your account to unblock and use the application again."),
      actions: <Widget>[
        TextButton(
          child: Text("OK"),
          onPressed: () {
